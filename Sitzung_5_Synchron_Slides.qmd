...
<br>
[{{< fa arrows-turn-to-dots >}}]{.imp} Elaboration anhand »Live-Studie«
...
<br>
[{{< fa arrow-down-long >}}]{.imp} Vertiefung mit Software
...
## {{< fa arrows-turn-to-dots >}} Elaboration mit Live-Experiment {.smaller .center}
> Bitte bearbeiten Sie die Survey unter [https://bit.ly/merk105 {{< fa square-up-right >}}](https://bit.ly/merk105)

> Unter allen, die ihre anonymisierten Daten spenden losen wir wieder einen 10€ Gutschein aus.

## {{< fa arrows-turn-to-dots >}} Elaboration mit Knobelaufgaben {.smaller .center}

#### Kurze Wdh. $U_1$, $U_3$, Cliff's $d$
...
## {{< fa arrow-down-long >}} Vertiefung mit Software {.center}
* In Sitzung 3 haben wir ein Experiment im Rahmen einer Masterarbeit durchgeführt
* Die aufbereiteten Daten können Sie `r xfun::embed_file("contrasteffect_suf.omv", name = "contrasteffect_suf.omv", text = "hier") ` herunterladen
* Unter [https://cloud.jamovi.org {{< fa square-up-right >}}](https://cloud.jamovi.org) können Sie den Datensatz analysieren, ich demonstriere Ihnen in der Präsenzsitzung wie
* Sie können auch die freien und Open-Source [{{< ai open-access >}}]{.imp} Softwarepakete [JASP {{< fa square-up-right >}}](https://jasp-stats.org/download/) und [jamovi {{< fa square-up-right >}}](https://www.jamovi.org) herunterladen und lokal installieren
